...
parser = argparse.ArgumentParser(description='Products (GraphSAGE Full-Batch)')
...
log_name = 'dgl_graphsage-full-batch-ogbn-products-' + device
...
print('DGL, products, GraphSAGE, full-batch, ' + device)
