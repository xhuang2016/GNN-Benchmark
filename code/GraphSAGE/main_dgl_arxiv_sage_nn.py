...
parser = argparse.ArgumentParser(description='Arxiv (GraphSAGE Full-Batch)')
...
log_name = 'dgl_graphsage-full-batch-ogbn-arxiv-' + device
...
print('DGL, arxiv, GraphSAGE, full-batch, ' + device)
