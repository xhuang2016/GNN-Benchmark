...
parser = argparse.ArgumentParser(description='Yelp (GraphSAGE Full-Batch)')
...
log_name = 'dgl_graphsage-full-batch-yelp-' + device
...
print('DGL, yelp, GraphSAGE, full-batch, ' + device)
