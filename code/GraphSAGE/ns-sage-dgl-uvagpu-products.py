...
log_name = 'dgl_graphsage-ogbn-products-uvagpu'
...
graph, num_classes = load_ogb('ogbn-products', root=path)
...
sampler = dgl.dataloading.NeighborSampler([25, 10], prefetch_node_feats=['feat'], prefetch_labels=['label'])
train_dataloader = dgl.dataloading.DataLoader(
        graph, train_idx.to('cuda'), sampler, device='cuda', batch_size=512, shuffle=True,
...
print('DGL, products, GraphSAGE, mini-batch, uvagpu')
