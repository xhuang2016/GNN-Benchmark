...
log_name = 'dgl_graphsaint-ogbn-arxiv-cpugpu'
...
model = GraphSAINT(graph.ndata['feat'].shape[1], 256, dataset.num_classes).to('cuda')
...
print('DGL, ogbn-arxiv, GraphSAINT, cuda')
