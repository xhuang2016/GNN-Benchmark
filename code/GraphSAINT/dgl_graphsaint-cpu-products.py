...
log_name = 'dgl_graphsaint-ogbn-products-cpu'
...
model = GraphSAINT(graph.ndata['feat'].shape[1], 256, dataset.num_classes).to('cpu')
...
print('DGL, ogbn-products, GraphSAINT, cpu')
