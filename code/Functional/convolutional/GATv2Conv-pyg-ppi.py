...
conv = torch_geometric.nn.GATv2Conv(dataset.num_features, 256, heads=1, concat=True, negative_slope = 0.2, dropout = 0.0, 
                                  add_self_loops = False, edge_dim = None, fill_value = 'mean', bias = True, share_weights=False).to(device)
